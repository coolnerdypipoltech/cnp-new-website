...
export const CNP_PROJECTS = [
  ...
  },
  {
    ...
    video: [A("/assets/proyects/videos/desktop/16X9_Femenine_TVC.mp4"), A("/assets/proyects/videos/Femenine_Eva1.mp4"), A("/assets/proyects/videos/Femenine_Eva2.mp4"), A("/assets/proyects/videos/desktop/16X9_Femenine_Stand.mp4")],
    videoMobil: [A("/assets/proyects/videos/mobile/9X16_Femenine_TVC.mp4"), A("/assets/proyects/videos/Femenine_Eva1.mp4"), A("/assets/proyects/videos/Femenine_Eva2.mp4"), A("/assets/proyects/videos/mobile/9X16_Femenine_Stand.mp4")],
    videoFill: [true, true, false, false, true],
